...
public class GridFragment extends BaseFragment {
    ...
    private OnGridSKipListenter listenter;
    ...
    protected void populate() {
        ...
        gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                listenter.onGridSKip(adapter.getPosition(results.get(position)));
            }
        });
        tvView.setOnClickListener( v -> listenter.gotoChart());
    }
    @Override
    ...
    public void onAttach(Context context) {
        ...
        try{
            listenter= (OnGridSKipListenter) context;
    ...
    public  interface  OnGridSKipListenter{
