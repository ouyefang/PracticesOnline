...
public class QuestionActivity extends AppCompatActivity {
    ...
    private View[] dots;
    private int pos;
    private static final int WHAT_RESPONSE_CODE = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshDots(pos);
        UserCookies.getInstance().updateReadCount(questions.get(pos).toString());
    }
    ...
    private void commitPractice() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("提交",(dialog, which) -> {
                    PracticeResult result=new PracticeResult(results,apiId,"欧叶芳："+info);
                    postResult(result);
                }).show();
    ...
    public static class ResultHandler extends AbstractStaticHandler<QuestionActivity> {
    ...
    private  ResultHandler handler=new QuestionActivity.ResultHandler(this);

    private void postResult(PracticeResult result) {
        ViewUtils.showProgress(this,"正在提交成绩......");
        AppUtils.getExecutor().execute(()-> {
            try{
                int code= PracticeService.posetResult(result);
    ...
    private void initViews() {
        ...
        tvCommit = findViewById(R.id.activity_question_commit);
